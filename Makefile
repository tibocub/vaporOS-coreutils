...
# See vapor-nostdinc.mk itself (in vaporOS-nuttx, this repo's own
# sibling) for the full rationale -- this was the actual root cause of
# a real build failure this had without it, discovered here first
# before being centralized into that shared file.
